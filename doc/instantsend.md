...
This mechanism has been integrated into Bitcore-Node-Depths which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Depths/insight-api-Depths#web-socket-api](https://github.com/Depths/insight-api-Depths#web-socket-api)
* API: [https://github.com/Depths/insight-api-Depths#instantsend-transactions](https://github.com/Depths/insight-api-Depths#instantsend-transactions)
