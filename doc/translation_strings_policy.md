...
This document provides guidelines for internationalization of the Depths Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `Depths_en.ts` remains unchanged.
