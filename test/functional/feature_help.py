...
"""Verify that starting Depthsd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start Depthsd with -h for help text")
        ...
        self.log.info("Start Depthsd with -version for version information")
