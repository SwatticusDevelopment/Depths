...
rm -f src/config/Depths-config.h
...
rm -rf test_bitcoin.coverage/ Depths-gtest.coverage/ total.coverage/
...
clean_exe src/Depths-cli
clean_exe src/Depthsd
clean_exe src/Depths-gtest
clean_exe src/Depths-tx
clean_exe src/test/test_Depths
clean_exe src/test/test_Depths_fuzzy
...
clean_dep . src/config/Depths-config.h.in
