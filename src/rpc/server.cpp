...
CAmount AmountFromValue(const UniValue& value, bool p_isDepths)
{
    ...
    if (p_isDepths && !MoneyRange(amount))
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "Depths Core server stopping";
}
...
{
    return "> Depths-cli " + methodname + " " + args + "\n";
}
