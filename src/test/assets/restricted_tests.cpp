...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler Depths tx
        CScript DepthsTransfer = GetScriptForDestination(DecodeDestination(Params().GlobalBurnAddress()));
        CTxOut DepthsOut(1*COIN, DepthsTransfer);
        ...
        mutTxTest1.vout.emplace_back(DepthsOut); 
        ...
        mutTxTest2.vout.emplace_back(DepthsOut);
        ...
        mutTxTest3.vout.emplace_back(DepthsOut);
        ...
        mutTxTest4.vout.emplace_back(DepthsOut);
        ...
        mutTxTest5.vout.emplace_back(DepthsOut);
        ...
        mutTxTest6.vout.emplace_back(DepthsOut);
        ...
        mutTxTest7.vout.emplace_back(DepthsOut);
        ...
        mutTxTest8.vout.emplace_back(DepthsOut);
