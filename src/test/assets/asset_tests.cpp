...
BOOST_FIXTURE_TEST_SUITE(asset_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(name_validation_tests)
    {
        ...
        //- Versions of Depths NOT allowed
        ...
        BOOST_CHECK(IsAssetNameValid("Depths.COIN", type));
        BOOST_CHECK(IsAssetNameValid("RAVEN_COIN", type));
        BOOST_CHECK(IsAssetNameValid("Depths_COIN", type));
        ...
        BOOST_CHECK(IsAssetNameValid("BLACK_Depths", type));
