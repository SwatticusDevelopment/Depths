...
public:
    CMainParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 1047200;
        ...
        consensus.nPowTargetTimespan = 2016 * 60; // Depths: 1 day
        consensus.nPowTargetSpacing = 1 * 60; // Depths: 1 minutes
   ...
   //   FindMainNetGenesisBlock(1652138420, 0x20001fff, "main");
        ...
        vSeeds.emplace_back("seed.Depths.net", false);
	    vSeeds.emplace_back("seed1.Depths.net", false);
	    vSeeds.emplace_back("seed2.Depths.net", false);
        ...
        // Depths BIP44 cointype in mainnet is '1668'
        nExtCoinType = 1668;
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the Depths chain
...
public:
    CTestNetParams() {
     ...
     //   consensus.DIP0003EnforcementHeight = 7300;
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 2016 * 60; // Depths: 1 day
        consensus.nPowTargetSpacing = 60; // Depths: 1 minutes
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 1;
		consensus.DGWBlocksAvg = 60;
        ...
        vSeeds.emplace_back("testnet.Depths.net", false);

        // Testnet Depths addresses start with 'r'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,42);
        // Testnet Depths script addresses start with '8' or '9'
        ...
        // Testnet Depths BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Depths BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Depths BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 10227;
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Depths: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Depths: 2.5 minutes
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("Depthsevo.org",  "devnet-seed.Depthsevo.org"));

        // Testnet Depths addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        consensus.powLimit = uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 1
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Depths: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Depths: 2.5 minutes
        ...
        // Regtest Depths addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Depths script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Depths BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Depths BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Depths BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
