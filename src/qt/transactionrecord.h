...
public:
    ...
    TransactionRecord():
            hash(), time(0), type(Other), strAddress(""), debit(0), credit(0),assetName("Depths"), units(8), idx(0)
    {
    ...
    TransactionRecord(uint256 _hash, qint64 _time):
            ...
            credit(0), assetName("Depths"), units(8), idx(0)
    {
        address = CBitcoinAddress(strAddress);
        txDest = address.Get();
    }
    ...
    TransactionRecord(uint256 _hash, qint64 _time,
            ...
            assetName("Depths"), units(8), idx(0)
    {
        address = CBitcoinAddress(strAddress);
        txDest = address.Get();
    }
