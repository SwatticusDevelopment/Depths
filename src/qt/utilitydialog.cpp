    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  Depths-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Depths in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.1 Depths, 1 Depths, 10 Depths, 100 Depths and 1000 Depths -- sort of like the paper money you use every day.</li> \
