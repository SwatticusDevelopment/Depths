Contributing to Depths Core
============================

The Depths Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/The-Depths-Endeavor/Depths/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Depths Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Depths
Network Protocol consensus changes.

Whether a pull request is merged into Depths Core rests with the project merge
...
Patches that change Depths consensus rules are considerably more involved than
...
Where a patch set proposes to change the Depths consensus, it must have been
...
The review process is normally fairly responsive on the Depths Core repository, however
...
The project leader is the release manager for each Depths Core release.
